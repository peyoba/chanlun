...
details{margin:2px 0}summary{cursor:pointer}.pass{color:#2ca02c}.fail{color:#d62728}.weak{color:#ff7f0e}small{color:#666}</style>"""
...
def render_stock(res: AnalysisResult, path: Path, cfg: AppConfig, show_fx: bool = True) -> Path:
